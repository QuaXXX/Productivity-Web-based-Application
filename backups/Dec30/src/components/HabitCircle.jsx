    ...
    return (
        ...
        >
            <div className={`
                ...
                ${isCompleted
                    ? 'bg-gradient-to-tr from-green-400 to-emerald-500 text-white scale-100 shadow-sm'
                    : 'bg-white p-[3px] scale-100' // p-[3px] simulates white gap
                }
            `}>
            ...
            <span className="text-[10px] font-medium text-gray-700 text-center max-w-[64px] truncate w-full">
                {title}
            </span>
        </motion.div>
    );
