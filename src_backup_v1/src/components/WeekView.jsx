...
const WeekView = ({ history, onNavigateToToday, onAddFutureTask, selectedDayIndex, setSelectedDayIndex }) => {
    ...
    if (selectedDayIndex === null) {
        return (
            <div className="flex flex-col h-full relative">
                <div className="space-y-4 pb-24 overflow-y-auto h-full pr-2">
