    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            ...
            <motion.form
                ...
                className="bg-white rounded-2xl shadow-xl p-5 w-full max-w-sm relative z-10"
            >
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                        {suggestedIcons.map(emoji => (
                            <button
                                ...
                                className={`w-10 h-10 rounded-lg flex items-center justify-center text-xl transition-all flex-shrink-0 ${icon === emoji ? 'bg-blue-100 border-2 border-blue-500' : 'bg-gray-50 border border-transparent hover:bg-gray-100'}`}
                            >
                                {emoji}
                            </button>
                        ))}
